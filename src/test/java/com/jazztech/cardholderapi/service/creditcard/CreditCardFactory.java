...
public class CreditCardFactory {
    ...
    static final BigDecimal MOCKED_LIMIT = BigDecimal.valueOf(15000);
    static final Short MOCKED_CVV = 392;
    static final LocalDate MOCKED_DUE_DATE = LocalDate.of(2033,6,26);

    static CreditCardRequest creditCardRequestFactory() {
    ...
    static CreditCardEntity creditCardEntityFactory() {
    ...
    static CreditCardModel creditCardModelFactory() {
